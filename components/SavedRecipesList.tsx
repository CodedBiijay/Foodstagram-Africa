...
import { Clock, ChefHat, Trash2, ArrowRight, BookOpen, CloudOff } from 'lucide-react';
...
const SavedRecipesList: React.FC<SavedRecipesListProps> = ({ recipes, onSelectRecipe, onDeleteRecipe, onBack }) => {
  if (recipes.length === 0) {
    return (
    ...
    <div className="w-full max-w-6xl mx-auto px-4 py-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {recipes.map((recipe, idx) => (
          <div key={recipe.id || idx} className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition duration-300 overflow-hidden border border-gray-100 flex flex-col group">
